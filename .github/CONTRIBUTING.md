...
* The #newpipe channel on Libera Chat (`ircs://irc.libera.chat:6697/youdown`) has the core team and other developers in it. [Click here for webchat](https://web.libera.chat/#youdown)!
* You can also use a Matrix account to join the YouDown channel at [#newpipe:libera.chat](https://matrix.to/#/#youdown:libera.chat). Some convenient clients, available both for phone and desktop, are listed at that link.
